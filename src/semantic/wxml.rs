...
pub(super) fn find_wxml_semantic_tokens(
    ...
    fn collect_in_common_attrs(tokens: &mut Vec<WxmlToken>, common: &CommonElementAttributes) {
        ...
        for attr in common.event_bindings.iter() {
            tokens.push(WxmlToken {
                location: attr.prefix_location.clone(),
                ty: TokenType::Keyword,
                modifier: 0,
            });
            tokens.push(WxmlToken {
                ...
                Node::Element(elem) => match &elem.kind {
                    ElementKind::Normal {
                        ...
                        if let Some(x) = elem.tag_location.end.as_ref() {
                            ...
                            tokens.push(WxmlToken {
                                location: elem.tag_location.close.clone(),
                                ty: TokenType::Type,
                                modifier: 0,
                            });
                        }
    ...
    fn collect_in_value_with_static_type(
        tokens: &mut Vec<WxmlToken>,
        value: &Value,
        ty: TokenType,
    ) {
        match value {
            ...
            Value::Dynamic {
                ...
                tokens.push(WxmlToken {
                    location: double_brace_location.1.clone(),
                    ty: TokenType::Operator,
                    modifier: 0,
                });
            }
    ...
    fn collect_in_expr(tokens: &mut Vec<WxmlToken>, expr: &Expression) {
        match expr {
            Expression::Cond {
                ...
                tokens.push(WxmlToken {
                    location: question_location.clone(),
                    ty: TokenType::Operator,
                    modifier: 0,
                });
            ...
            Expression::LitObj {
                ...
                tokens.push(WxmlToken {
                    location: brace_location.0.clone(),
                    ty: TokenType::Operator,
                    modifier: 0,
                });
                for field in fields {
                ...
                tokens.push(WxmlToken {
                    location: brace_location.1.clone(),
                    ty: TokenType::Operator,
                    modifier: 0,
                });
            }
            Expression::LitArr {
                ...
                tokens.push(WxmlToken {
                    location: bracket_location.0.clone(),
                    ty: TokenType::Operator,
                    modifier: 0,
                });
                for field in fields {
                ...
                tokens.push(WxmlToken {
                    location: bracket_location.1.clone(),
                    ty: TokenType::Operator,
                    modifier: 0,
                });
            }
            ...
            Expression::FuncCall {
                ...
                tokens.push(WxmlToken {
                    location: paren_location.0.clone(),
                    ty: TokenType::Operator,
                    modifier: 0,
                });
                for arg in args {
                ...
                tokens.push(WxmlToken {
                    location: paren_location.1.clone(),
                    ty: TokenType::Operator,
                    modifier: 0,
                });
            }
    ...
    for sub in template.globals.sub_templates.iter() {
        tokens.push(WxmlToken {
            location: sub.name_location.clone(),
            ty: TokenType::Keyword,
            modifier: 0,
        });
